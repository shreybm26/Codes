...
def send_message():
    ...
    chat_log.tag_configure("user_tag", justify="right", background="#a0e0a0")
    chat_log.tag_configure("bot_tag", background="#f0f0f0")
...
chat_log = scrolledtext.ScrolledText(window, wrap=tk.WORD, width=50, height=20, font="cambria")
chat_log.pack()
